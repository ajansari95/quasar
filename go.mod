...
require (
	...
	github.com/osmosis-labs/fee-abstraction/v4 v4.0.0-20230911105409-ec0f54c1f3a5
...
replace (
	...
	// github.com/cosmos/ibc-go/v4 => github.com/strangelove-ventures/ibc-go/v3 v3.0.0-20221014082552-99c8caa484af
