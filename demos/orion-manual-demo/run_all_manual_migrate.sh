...
osmosisd tx gamm create-pool --pool-file ./sample_pool1.json --node http://127.0.0.1:26679 --from bob --keyring-backend test --home $HOME/.osmosisd --chain-id osmosis -y --gas-prices 1uosmo
sleep 6
